...
def trainiters(pairs, encoder, decoder,  epoches, plot_every=500, train_pairs_seed=1, learning_rate=.005):
    ...
    # 存一下这里生成的数据集，后续分析要用
    file_object_train = open('0512train_dataset.txt', 'a', encoding='utf-8')
    ...
    file_object_val = open('0512validate_dataset.txt', 'a', encoding='utf-8')
    ...
    file_object_test = open('0512test_dataset.txt', 'a', encoding='utf-8')
...
trainiters(pairs, encoder, decoder, epoches=n_epoches,learning_rate=learning_rate, plot_every=plot_every)
